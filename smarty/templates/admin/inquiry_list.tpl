...
{if $back_page_flg == true}
  <a href="./inquiry_list.php?sort={$sort}&{$uri_params|unescape}&p={$back_page}" class="btn btn-normal"><< back <<</a>
{else}
      << back <<
{/if}
{if $next_page_flg == true}
  <a href="./inquiry_list.php?sort={$sort}&{$uri_params|unescape}&p={$next_page}" class="btn btn-normal">>> next >></a>
{else}
     >> next >>
{/if}
